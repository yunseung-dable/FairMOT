...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='',
                             help='path to pretrained model')
    self.parser.add_argument('--resume', default='store_true',
    ...
    self.parser.add_argument('--num_iters', type=int, default= 500,
  ...
  def parse(self, args=''):
    ...
    opt.save_dir = os.path.join('/data/models/mot/fairmot', opt.exp_id)
